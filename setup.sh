...
show_help() {
  ...
  echo "  -o    Install ${COLOR_GREEN}Oh My Zsh${COLOR_RESET} (a popular Zsh configuration framework)"
  echo "  -v    Install ${COLOR_GREEN}Vim${COLOR_RESET} with a basic configuration and useful plugins"
  echo "  -t    Install ${COLOR_GREEN}tmux${COLOR_RESET} (terminal multiplexer for session management)"
  echo "  -b    Install ${COLOR_GREEN}build-essential${COLOR_RESET} (gcc, g++, make, and other essential build tools)"
  echo "  -g    Install ${COLOR_GREEN}Git${COLOR_RESET} (version control system) and a default config file"
  echo "  -H    Install ${COLOR_GREEN}htop${COLOR_RESET} (interactive process viewer)"
  echo "  -s    Install ${COLOR_GREEN}The Silver Searcher (ag)${COLOR_RESET} (fast code search tool)"
  echo "  -x    Install ${COLOR_GREEN}exa${COLOR_RESET} (modern replacement for ls with enhanced features)"
  echo "  -G    Install ${COLOR_GREEN}GDB${COLOR_RESET} (GNU Debugger for debugging C/C++ programs)"
  echo "  -C    Install ${COLOR_GREEN}Clang${COLOR_RESET} (alternative C/C++ compiler with better diagnostics)"
  echo "  -V    Install ${COLOR_GREEN}Valgrind${COLOR_RESET} (memory debugging and profiling tool)"
  echo "  -D    Install ${COLOR_GREEN}Docker${COLOR_RESET} (container platform for isolated environments)"
  echo "  -n    Install ${COLOR_GREEN}ncdu${COLOR_RESET} (disk usage analyzer with a nice CLI interface)"
